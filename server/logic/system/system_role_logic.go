...
func (l RoleLogic) Add(c *gin.Context, req interface{}) (data interface{}, rspError interface{}) {
	r, ok := req.(*systemReq.RoleAddReq)
	if !ok {
		return nil, tools.ReqAssertErr
	}
	_ = c

	if roleService.Exist(tools.H{"name": r.Name}) {
...
func (l RoleLogic) List(c *gin.Context, req interface{}) (data interface{}, rspError interface{}) {
	r, ok := req.(*systemReq.RoleListReq)
	if !ok {
		return nil, tools.ReqAssertErr
	}
	_ = c
...
func (l RoleLogic) Update(c *gin.Context, req interface{}) (data interface{}, rspError interface{}) {
	r, ok := req.(*systemReq.RoleUpdateReq)
	if !ok {
		return nil, tools.ReqAssertErr
	}
	_ = c
	...
	// 不能更新比自己角色等级高或相等的角色
	// 根据path中的角色ID获取该角色信息
	roles, _ := roleService.GetRolesByIds([]uint{r.ID})
	if len(roles) == 0 {
	...
	oldData := new(system.Role)
	err = roleService.Find(filter, oldData)
	if err != nil {
	...
	if r.Keyword != roles[0].Keyword {
		...
		//if !isUpdated {
		//	systemRsp.Fail(c, nil, "更新角色成功，但角色关键字关联的权限接口更新失败！")
		//	return
		//}
...
func (l RoleLogic) Delete(c *gin.Context, req interface{}) (data interface{}, rspError interface{}) {
	r, ok := req.(*systemReq.RoleDeleteReq)
	if !ok {
		return nil, tools.ReqAssertErr
	}
	_ = c
	...
	// 删除角色
	err = roleService.Delete(r.RoleIds)
	if err != nil {
...
func (l RoleLogic) GetMenuList(c *gin.Context, req interface{}) (data interface{}, rspError interface{}) {
	r, ok := req.(*systemReq.RoleGetMenuListReq)
	if !ok {
		return nil, tools.ReqAssertErr
	}
	_ = c

	menus, err := roleService.GetRoleMenusById(r.RoleID)
	if err != nil {
...
func (l RoleLogic) GetApiList(c *gin.Context, req interface{}) (data interface{}, rspError interface{}) {
	r, ok := req.(*systemReq.RoleGetApiListReq)
	if !ok {
		return nil, tools.ReqAssertErr
	}
	_ = c
	...
	err := roleService.Find(tools.H{"id": r.RoleID}, role)
	if err != nil {
...
func (l RoleLogic) UpdateMenus(c *gin.Context, req interface{}) (data interface{}, rspError interface{}) {
	r, ok := req.(*systemReq.RoleUpdateMenusReq)
	if !ok {
		return nil, tools.ReqAssertErr
	}
	_ = c

	roles, _ := roleService.GetRolesByIds([]uint{r.RoleID})
	if len(roles) == 0 {
	...
	// 获取当前用户所拥有的权限菜单
	ctxUserMenus, err := menuService.GetUserMenusByUserId(ctxUser.ID)
	if err != nil {
	...
	err = roleService.UpdateRoleMenus(roles[0])
	if err != nil {
...
func (l RoleLogic) UpdateApis(c *gin.Context, req interface{}) (data interface{}, rspError interface{}) {
	r, ok := req.(*systemReq.RoleUpdateApisReq)
	if !ok {
		return nil, tools.ReqAssertErr
	}
	_ = c
	...
	// 根据apiID获取接口详情
	apis, err := apiService.GetApisById(r.ApiIds)
	if err != nil {
	...
	// 更新角色的权限接口
	err = roleService.UpdateRoleApis(roles[0].Keyword, reqRolePolicies)
	if err != nil {
