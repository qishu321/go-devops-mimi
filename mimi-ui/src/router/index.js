...
export const constantRoutes = [
  ...
  },
  {
    path: '/library_info',
    component: Layout,
    redirect: '/exec/script/library/info',
    hidden: true,
    children: [
      {
        path: '/libraryInfo',
        component: () => import('@/views/exec/script/library/info'),
        name: 'libraryInfo',
        meta: { title: '脚本详情', icon: 'info', noCache: true }
      }
    ]
  },
// ... existing code ...
{
  path: '/exec/task/manage/add',
  name: 'TaskManageAdd',
  component: () => import('@/views/exec/task/manage/add/index.vue')
},
{
  path: '/exec/task/manage/update',
  name: 'TaskManageUpdate',
  component: () => import('@/views/exec/task/manage/update/index.vue')
},
{
  path: '/exec/task/manage/info',
  name: 'TaskManageInfo',
  component: () => import('@/views/exec/task/manage/info/index.vue')
},
